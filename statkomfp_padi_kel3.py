# -*- coding: utf-8 -*-
"""StatkomFP_padi_kel3.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/13E_x-_TG0y9ggldx-WG6Vi4bGnaIuuDp
...
def user_input_and_predict():
    ...
    print("=" * 50)
    print("| {:<30} | {:<15} |".format("Fitur", "Nilai"))
    print("=" * 50)

    # Mengambil input untuk setiap fitur
    for feature in features:
        while True:
            try:
                # Meminta nilai berdasarkan fitur (satuan)
                value = float(input(f"| {feature:<30} | "))
                user_input[feature.split(' ')[0]] = value  # Menyimpan nilai dengan nama fitur tanpa satuan
                print("=" * 50)
                break
            except ValueError:
                print("| Input tidak valid. Harap masukkan angka.".ljust(50) + "|")
    ...
    # Output hasil prediksi dalam format tabel
    print("=" * 50)
    print(f"| {'Prediksi Produktivitas Padi':<30} | {'Rendah' if prediksi == 0 else 'Tinggi'  :<15} |")
    print("=" * 50)
